...
const schema = z.object({
    ...
    confirmNewPassword: z.string().min(5, {message:"Confirm Password is required"}),
      id: z.string().min(1, {message:"User Id should not be empty"}),
              ...
              {error && (
                <div>
                  ...
                  <div className="flex mt-8 justify-between text-sm  font-medium text-gray-500 dark:text-gray-300">
                    <Link to={"/login"}>
                      <span className=" rounded  dark:text-blue-700 w-full flex  gap-2 items-center justify-center  px-5 py-2 text-sm font-medium text-white">
                        Go to login
                      </span>
                    </Link>
            ...
            <div className="flex flex-col items-center">
              ...
              />
                          ...
                          >
                            <input
                              type="password"
                              className="h-full rounded-lg p-3 w-full bg-white outline-none text-blue-900"
                        ...
                        <div>
                          ...
                          <div className="relative">
                            <input
                              type="password"
                              className={`w-full rounded-lg border-[1px] text-blue-900 ${
                                formState.errors.confirmNewPassword ? "border-red-500" : ""
                              } ${
                                isFieldValid("confirmNewPassword") ? "border-green-500" : ""
                            ...
                            <span className="absolute inset-y-0 end-0 grid place-content-center px-4">
                              {isFieldValid("confirmNewPassword") && (
                                <div>
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="26"

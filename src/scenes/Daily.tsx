...
const Daily = () => {
  ...
  const [totalSalesLine, totalUnitsLine] = useMemo(() => {
    ...
    if (!firstOverview || !Array.isArray(firstOverview.dailyData)) {
      // console.error("Invalid data structure:", firstOverview);
      return [[], []];
    }

    const { dailyData } = firstOverview;
  ...
  }, [data, startDate, endDate, theme.palette.secondary.main, theme.palette.secondary[600]]);
